  ...
  return (
    <>
      <SEO 
        ...
        description="Bienvenue sur votre tableau de bord Smart Scan Storage - Gérez vos documents intelligemment"
        canonicalUrl="/"
        jsonLd={{
          '@context': 'https://schema.org',
          '@type': 'WebPage',
          name: 'Tableau de bord Smart Scan Storage',
          description: 'Gérez vos documents intelligemment',
      ...
      <div className="space-y-8 animate-fadeIn">
          ...
          <Link to="/upload" className="group">
            <div className="card p-6 hover:shadow-xl transition-all duration-300 group-hover:scale-105">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">Téléverser des documents</h2>
          ...
          <Link to="/search" className="group">
            <div className="card p-6 hover:shadow-xl transition-all duration-300 group-hover:scale-105">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">Rechercher des documents</h2>
        ...
        <ExternalNews keyword="gestion documentaire" />
